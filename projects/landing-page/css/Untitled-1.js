...
*/
	...
	var wa = Array.prototype.indexOf
		...
		Ea = function(a, b) {
			...
			var c;
			if ((c = 0 <= b))
				x(null != a.length), Array.prototype.splice.call(a, b, 1);
			return c;
		},
		Fa = function(a) {
	...
	var ob = function(a) {
		...
		rb = function(a) {
			...
			if (/[{;}]/.test(a))
				throw new oa('Value does not allow [{;}], got: %s.', [a]);
			return a;
		},
		qb = function(a) {
			var b = a
			...
			if (ub.test(b)) {
				if (vb.test(a))
					return y('String value disallows comments, got: ' + a), 'zClosurez';
				...
				if (!b || !c)
					return (
						y('String value requires balanced quotes, got: ' + a), 'zClosurez'
					);
				if (!wb(a))
					return (
						y(
	...
	var Kb = Nb('', 0);
	Nb('<br>', 0);
	var Ob = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
		Pb = Ha(function() {
	...
	var ac = E('Opera'),
		...
		G =
			E('Gecko') &&
			!(-1 != C.toLowerCase().indexOf('webkit') && !E('Edge')) &&
			!(E('Trident') || E('MSIE')) &&
			!E('Edge'),
		H = -1 != C.toLowerCase().indexOf('webkit') && !E('Edge'),
		dc = H && E('Mobile'),
		I = E('Macintosh'),
		ec = E('Windows'),
		fc = E('Android'),
	...
	M.prototype.translate = function(a, b) {
		a instanceof M
			? ((this.a += a.a), (this.b += a.b))
			: ((this.a += Number(a)), 'number' === typeof b && (this.b += b));
		return this;
	};
	var Rc = function(a, b) {
		this.width = a;
	...
	var Tc = function(a) {
		...
		Vc = function(a, b) {
			...
			if (c.getElementsByClassName) a = c.getElementsByClassName(a)[0];
				...
				if (d.querySelectorAll && d.querySelector && a)
					a = d.querySelector(a ? '.' + a : '');
				else {
					b = b || c;
					if (b.querySelectorAll && b.querySelector && a)
						a = b.querySelectorAll(a ? '.' + a : '');
		...
		$c = function(a) {
			var b = Yc(a);
			a = Zc(a);
			return F && J('10') && a.pageYOffset != b.scrollTop
		...
		id = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 },
		jd = { IMG: ' ', BR: '\n' },
		kd = function(a, b) {
		...
		nd = function(a, b, c) {
			if (!(a.nodeName in id))
				...
				else for (a = a.firstChild; a; ) nd(a, b, c), (a = a.nextSibling);
		},
		bd = function(a) {
	...
	h.getChildren = function(a) {
		return Oc && void 0 != a.children
			? a.children
			: xa(a.childNodes, function(b) {
					return 1 == b.nodeType;
			  });
	};
	h.contains = gd;
	...
	Jd.prototype.add = function(a, b, c, d, e) {
		...
		-1 < g
			? ((b = a[g]), c || (b.Ca = !1))
			: ((b = new Hd(b, this.src, f, !!d, e)), (b.Ca = c), a.push(b));
		return b;
	};
	...
	var Kd = function(a, b, c, d) {
		for (var e = 0; e < a.length; ++e) {
			var f = a[e];
			if (!f.removed && f.listener == b && f.capture == !!c && f.Ha == d)
				return e;
		}
		return -1;
	};
	var Md = 'closure_lm_' + ((1e6 * Math.random()) | 0),
		...
		Xd = function(a) {
			...
			b.removeEventListener
				...
				: b.detachEvent
				? b.detachEvent(Ud(c), d)
				: b.addListener && b.removeListener && b.removeListener(d);
			Od--;
			(c = Sd(b))
				? (Ld(c, a), 0 == c.b && ((c.src = null), (b[Md] = null)))
				: Id(a);
			return !0;
		},
		Zd = function(a) {
		...
		Vd = function(a, b) {
			...
			if (!wd) {
				...
				if (!(0 > d.keyCode || void 0 != d.returnValue)) {
					...
					for (e = 0; !b.g && e < d.length; e++)
						(b.a = d[e]), (f = ae(d[e], a, !1, b)), (c = c && f);
				}
				return c;
			}
	...
	h.dispatchEvent = function(a) {
		...
		a.g ||
			...
			a.g || (e = fe(g, d, !1, a) && e));
		if (c)
			for (f = 0; !a.g && f < c.length; f++)
				(g = a.a = c[f]), (e = fe(g, d, !1, a) && e);
		return e;
	};
	h.v = function() {
		R.s.v.call(this);
	...
	h.contains = function(a) {
		return a instanceof M
			? a.a >= this.left &&
					a.a <= this.left + this.width &&
					a.b >= this.top &&
					a.b <= this.top + this.height
			: this.left <= a.left &&
	...
	h.translate = function(a, b) {
		a instanceof M
			? ((this.left += a.a), (this.top += a.b))
			: ((this.left += qa(a)), 'number' === typeof b && (this.top += b));
		return this;
	};
	var je = function(a, b, c) {
		...
		ie = function(a, b) {
			...
			if (!c) {
				...
				void 0 === a.style[d] &&
					((d =
						(H ? 'Webkit' : G ? 'Moz' : F ? 'ms' : ac ? 'O' : null) + Ub(d)),
		...
		se = function(a) {
			for (
				var b = new ge(0, Infinity, Infinity, 0),
					c = Tc(a),
					d = c.a.body,
				...
				if (
					!(
						(F && 0 == a.clientWidth) ||
						(H && 0 == a.clientHeight && a == d)
					) &&
					a != d &&
					a != e &&
					'visible' != me(a, 'overflow')
				) {
					var g = re(a),
		...
		re = function(a) {
			...
			d = !F || rc(9) || ad(Tc(d).a) ? d.documentElement : d.body;
			if (a == d) return c;
			a = pe(a);
			b = $c(Tc(b).a);
			c.a = a.left + b.a;
		...
		we = function(a) {
			...
			return (void 0 === b || d) && a.getBoundingClientRect
				? ((a = pe(a)), new Rc(a.right - a.left, a.bottom - a.top))
				: new Rc(b, c);
		},
		ye = function(a) {
			var b = re(a);
	...
	Xe.prototype.wa = function(a) {
		return a.h.nb('DIV', $e(this, a).join(' '), a.getContent());
	};
	...
	Xe.prototype.aa = function(a, b) {
		b.id && Je(a, b.id);
		b && b.firstChild
			? cf(a, b.firstChild.nextSibling ? Ga(b.childNodes) : b.firstChild)
			: (a.xa = null);
		var c = 0,
			d = this.B(),
			e = this.B(),
	...
	var ef = function(a, b) {
		if ((a = a.Va())) {
			...
			a != c &&
				(a
					? (x(Ka(Mc, a), 'No such ARIA role ' + a), b.setAttribute('role', a))
	...
	h.X = function(a, b, c) {
		Ye ||
			(Ye = { 1: 'disabled', 8: 'selected', 16: 'checked', 64: 'expanded' });
	...
	h.Lb = function(a) {
		...
		-1 == this.I &&
			(a.ctrlKey && 17 != a.keyCode
				...
				? (this.I = 18)
				: a.metaKey && 91 != a.keyCode && (this.I = 91));
		sf && !nf(a.keyCode, this.I, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
			? this.handleEvent(a)
			: ((this.W = mf(a.keyCode)), tf && (this.Oa = a.altKey));
	};
	h.Nb = function(a) {
		this.W = this.I = -1;
		this.Oa = a.altKey;
	...
	h.handleEvent = function(a) {
		...
		if (F && 'keypress' == a.type) {
			...
			(H || bc) && 'keypress' == a.type
				? ((d = this.W),
				  (e = 0 <= b.charCode && 63232 > b.charCode && lf(d) ? b.charCode : 0))
				: ac && !H
				? ((d = this.W), (e = lf(d) ? b.keyCode : 0))
				: ('keypress' == a.type
						? (tf && (c = this.Oa),
						  b.keyCode == b.charCode
								? 32 > b.keyCode
									? ((d = b.keyCode), (e = 0))
									: ((d = this.W), (e = b.charCode))
								: ((d = b.keyCode || this.W), (e = b.charCode || 0)))
						: ((d = b.keyCode || this.W), (e = b.charCode || 0)),
				  I && 63 == e && 224 == d && (d = 191));
		var f = (d = mf(d));
		d
			? 63232 <= d && d in qf
				? (f = qf[d])
				: 25 == d && a.shiftKey && (f = 9)
			: b.keyIdentifier && b.keyIdentifier in rf && (f = rf[b.keyIdentifier]);
		(G &&
			sf &&
			'keypress' == a.type &&
			!nf(f, this.I, a.shiftKey, a.ctrlKey, c, a.metaKey)) ||
			((a = f == this.I),
			(this.I = f),
			(b = new uf(f, e, a, b)),
			(b.altKey = c),
	...
	h.Y = function() {
		...
		this.g.yb(this);
		this.F & -2 &&
			(this.Za && vf(this, !0), this.F & 32 && (a = this.m())) &&
			((b = this.u || (this.u = new pf())),
			b.attach(a),
			Le(this)
	...
	var vf = function(a, b) {
		...
		b
			? (c
					...
					.listen(d, 'mouseout', a.vb),
			  a.Ga != p && c.listen(d, 'contextmenu', a.Ga),
			  F &&
					(J(9) || c.listen(d, 'dblclick', a.ub),
					a.C || ((a.C = new yf(a)), sd(a, v(td, a.C)))))
			: (c
					.N(d, Ad.Ma, a.ya)
					.N(d, [Ad.Na, Ad.ib], a.za)
					.N(d, 'mouseover', a.wb)
					.N(d, 'mouseout', a.vb),
			  a.Ga != p && c.N(d, 'contextmenu', a.Ga),
			  F && (J(9) || c.N(d, 'dblclick', a.ub), td(a.C), (a.C = null)));
	};
	...
	var cf = function(a, b) {
		...
		zf = function(a) {
			...
			if (!a) return '';
			if ('string' !== typeof a)
				if (Array.isArray(a)) a = ya(a, od).join('');
				else {
					if (Pc && null !== a && 'innerText' in a)
	...
	S.prototype.setEnabled = function(a) {
		var b = this.o;
		(b && 'function' == typeof b.b && !b.b()) ||
			!Af(this, 1, !a) ||
			(a || (Bf(this, !1), Cf(this, !1)),
			this.isVisible() && this.g.Ka(this, a),
			Df(this, 1, !a, !0));
	};
	var Cf = function(a, b) {
			Af(a, 2, b) && Df(a, 2, b);
	...
	var Df = function(a, b, c, d) {
			d || 1 != b
				? a.F & b &&
				  c != !!(a.w & b) &&
				  (a.g.Xa(a, b, c), (a.w = c ? a.w | b : a.w & ~b))
				: a.setEnabled(!c);
		},
		Ef = function(a) {
		...
		Af = function(a, b, c) {
			return (
				!!(a.F & b) &&
				!!(a.w & b) != c &&
				(!(0 & b) || a.dispatchEvent(Ie(b, c))) &&
				!a.D
			);
		};
	h = S.prototype;
	h.wb = function(a) {
		(!a.relatedTarget || !gd(this.m(), a.relatedTarget)) &&
	...
	h.vb = function(a) {
		(a.relatedTarget && gd(this.m(), a.relatedTarget)) ||
			...
			(T(this, 4) && Bf(this, !1), T(this, 2) && Cf(this, !1));
	};
	h.Ga = p;
	h.ya = function(a) {
		this.b() &&
			...
			Dd(a) &&
				(T(this, 4) && Bf(this, !0),
				this.g && this.g.rb(this) && this.m().focus()));
		Dd(a) && a.preventDefault();
	};
	h.za = function(a) {
		this.b() &&
			(T(this, 2) && Cf(this, !0),
			this.w & 4 && this.Aa(a) && T(this, 4) && Bf(this, !1));
	};
	h.ub = function(a) {
		this.b() && this.Aa(a);
	};
	...
	h.Mb = function(a) {
		return this.isVisible() && this.b() && this.Ya(a)
			? (a.preventDefault(), a.h(), !0)
			: !1;
	};
	h.Ya = function(a) {
	...
	Jf.prototype.Y = function() {
		...
		if (this.F & 32) {
			var a = this.m();
			a && Le(this).listen(a, 'keyup', this.Ya);
		}
	};
	...
	Kf.prototype.remove = function(a) {
		return Mf(this.b, a)
			? (delete this.b[a], this.g--, this.a.length > 2 * this.g && Lf(this), !0)
			: !1;
	};
	var Lf = function(a) {
		if (a.g != a.a.length) {
		...
		if (a.g != a.a.length) {
			...
			for (c = b = 0; b < a.a.length; )
				(d = a.a[b]), Mf(e, d) || ((a.a[c++] = d), (e[d] = 1)), b++;
			a.a.length = c;
		}
	};
	...
	Rf.prototype.remove = function(a) {
		...
		return Mf(this.a.b, a)
			? ((this.g = null),
			  (this.b = qa(this.b) - this.a.get(a).length),
			  this.a.remove(a))
			: !1;
	};
	...
	h.S = function(a) {
		...
		var b = [];
		if ('string' === typeof a)
			Tf(this, a) && (b = Fa(b, this.a.get(String(a))));
		else {
			a = this.a.S();
	...
	h.set = function(a, b) {
		...
		this.g = null;
		a = String(a);
		Tf(this, a) && (this.b = qa(this.b) - this.a.get(a).length);
		this.a.set(a, [b]);
		this.b = qa(this.b) + 1;
		return this;
	};
	...
	var ag = function(a) {
		...
		cg = function(a) {
			return $f(a, Uf, Yf)
				? a
				: a instanceof Db
				? bg(Eb(a).toString(), a.ha())
				: bg(Sb(String(String(a))), ag(a));
		},
		bg = (function(a) {
			function b(c) {
				this.content = c;
		...
		dg = function(a, b) {
			return a && b && a.Qb && b.Qb
				? a.ga !== b.ga
					? !1
					: a.toString() === b.toString()
				: a instanceof Wf && b instanceof Wf
				? a.ga != b.ga
					? !1
					: a.toString() == b.toString()
				: a == b;
		...
		jg = /^(?!on|src|(?:action|archive|background|cite|classid|codebase|content|data|dsync|href|http-equiv|longdesc|style|usemap)\s*$)(?:[a-z0-9_$:-]*)$/i,
	...
	var kg = function(a) {
		...
		z +=
			(dg(K, 1) ? ' jfk-button-narrow' : '') +
			(B ? ' jfk-button-checked' : '') +
			(a ? ' ' + a : '') +
			(D ? ' jfk-button-disabled' : '');
		d =
			e +
			U(z) +
			'"' +
			(d ? ' aria-disabled="true"' : ' tabindex="' + (f ? U(f) : '0') + '"') +
			(g
				? l
					? ' data-tooltip="' + U(g) + '"'
					: ' title="' + U(g) + '"'
		...
		b
			? ($f(b, Vf, Zf)
					? (b = b.getContent().replace(/([^"'\s])$/, '$1 '))
					: ((b = String(b)),
					  jg.test(b) ||
							(y('Bad value `%s` for |filterHtmlAttributes', [b]),
							(b = 'zSoyz'))),
			  (b = ' ' + b))
			: (b = '');
	...
	var mg = (function() {
		...
		return I
			? ((a = /10[_.][0-9_.]+/),
			  (a = a.exec(C)) ? a[0].replace(/_/g, '.') : '10')
			: fc
			? ((a = /Android\s+([^\);]+)(\)|;)/), (a = a.exec(C)) ? a[1] : '')
			: gc || hc || ic
			? ((a = /(?:iPhone|CPU)\s+OS\s+(\S+)/),
			  (a = a.exec(C)) ? a[1].replace(/_/g, '.') : '')
			: '';
	})();
	var ng = function(a) {
		...
		og = (function() {
			...
			if (vc || wc) {
				...
				return (a = ng(/Android\s+([0-9.]+)/)) ? a : ng(/Version\/([0-9.]+)/);
			return '';
		})();
	var pg = function(a, b) {
	...
	h.ob = function(a) {
		...
		var c = this.Qa,
			d =
				2 == this.Pa
					? sg(this.Qa)
						? this.a.offsetHeight / 2
						: this.a.offsetWidth / 2
					: this.jb;
		if (this.b) {
			var e = tg(c, b),
				f = this.b;
			...
			if ((k = se(f)))
				(f = ye(f)),
					(f = new ge(f.top, f.left + f.width, f.top + f.height, f.left)),
					sg(c)
						? f.top < k.top && !(l & 1)
							? (g -= k.top - f.top)
							: f.bottom > k.bottom && l & 1 && (g -= f.bottom - k.bottom)
						: f.left < k.left && !(l & 4)
						? (g -= k.left - f.left)
						: f.right > k.right && l & 4 && (g -= f.right - k.right);
			...
			if (m) {
				...
				if (!q || 'static' != me(m, 'position')) {
					...
					if (!q) {
						...
						q = B
							? -m.scrollLeft
							: !q || (cc && J('8')) || 'visible' == me(m, 'overflowX')
							? m.scrollLeft
			...
			if ((q = se(k))) {
				...
				q <= B &&
					((K = Math.max(m.top, z.top)),
					(z = Math.min(m.top + m.height, z.top + z.height)),
					K <= z &&
						((m.left = q), (m.top = K), (m.width = B - q), (m.height = z - K)));
			}
			q = Tc(k);
			K = Tc(g);
			if (q.a != K.a) {
			...
			if (a || 0 != l)
				l & 4
					? (k.a -= f.width + (a ? a.right : 0))
					: l & 2
					? (k.a -= f.width / 2)
					: a && (k.a += a.left),
					l & 1 ? (k.b -= f.height + (a ? a.bottom : 0)) : a && (k.b += a.top);
			a = new he(0, 0, 0, 0);
			a.left = k.a;
			a.top = k.b;
			a.width = f.width;
			...
			e == f ||
				(e && f && e.width == f.width && e.height == f.height) ||
				((a = f),
				(e = N(g)),
				(l = ad(Tc(e).a)),
				!F || J('10') || (l && J('8'))
					? ((g = g.style),
					  G
							? (g.MozBoxSizing = 'border-box')
							: H
							? (g.WebkitBoxSizing = 'border-box')
							: (g.boxSizing = 'border-box'),
					  (g.width = Math.max(a.width, 0) + 'px'),
					  (g.height = Math.max(a.height, 0) + 'px'))
					: ((e = g.style),
					  l
							? (F
									? ((l = De(g, 'paddingLeft')),
									  (k = De(g, 'paddingRight')),
									  (f = De(g, 'paddingTop')),
									  (D = De(g, 'paddingBottom')),
									  (l = new ge(f, k, D, l)))
									: ((l = le(g, 'paddingLeft')),
									  (k = le(g, 'paddingRight')),
									  (f = le(g, 'paddingTop')),
									  (D = le(g, 'paddingBottom')),
									  (l = new ge(
											parseFloat(f),
											parseFloat(k),
											parseFloat(D),
							  ...
							  F && !rc(9)
									? ((k = Fe(g, 'borderLeft')),
									  ...
									  (g = Fe(g, 'borderBottom')),
									  (g = new ge(D, f, g, k)))
									: ((k = le(g, 'borderLeftWidth')),
									  (f = le(g, 'borderRightWidth')),
									  (D = le(g, 'borderTopWidth')),
									  (g = le(g, 'borderBottomWidth')),
									  (g = new ge(
											parseFloat(D),
											parseFloat(f),
											parseFloat(g),
							  ...
							  (e.pixelWidth = a.width - g.left - l.left - l.right - g.right),
							  (e.pixelHeight =
									a.height - g.top - l.top - l.bottom - g.bottom))
							: ((e.pixelWidth = a.width), (e.pixelHeight = a.height))));
			this.o &&
				((g = parseFloat(this.a.style.left)),
				(a = parseFloat(this.a.style.top)),
				x(!isNaN(g) && !isNaN(a), 'Could not parse position.'),
				(isFinite(g) && 0 == g % 1 && isFinite(a) && 0 == a % 1) ||
					oe(this.a, Math.round(g), Math.round(a)));
		}
		ug(this, c, b, d);
	};
	var ug = function(a, b, c, d) {
			...
			a.b
				? ((c = ue(a.b, a.a)),
				  (d = vg(a.b, b)),
				  sg(b)
						? (e.style.top = wg(c.b + d.b, a.a.offsetHeight - 15) + 'px')
						: (e.style.left = wg(c.a + d.a, a.a.offsetWidth - 15) + 'px'))
				: (e.style[
						0 == c ? (sg(b) ? 'top' : 'left') : sg(b) ? 'bottom' : 'right'
				  ] = d + 'px');
		},
		wg = function(a, b) {
	...
	var Bg = function(a, b, c) {
			...
			1 == c.childNodes.length &&
				((a = c.firstChild), 1 == a.nodeType && (c = a));
			return c;
		},
		zg = function(a) {
			if (!t(a)) return Gb(String(a));
			if (a instanceof Wf) return Xf(a);
			y('Soy template output is unsafe for use as HTML: ' + a);
			return Gb('zSoyz');
		},
	...
	var Eg = function(a, b) {
			a.m() &&
				((a = a.m()),
				b
					? Te(a, 'jfk-button-clear-outline')
					: Ve(a, 'jfk-button-clear-outline'));
		},
		Dg = function(a) {
			a.m() && Fg(a.g, a);
		},
	...
	var Gg = function() {
		...
		xf(this, 'no-audio');
		this.qa = this.ra = '';
		Le(this).listen(this, 'action', this.La);
	};
	w(Gg, V);
	Gg.prototype.La = function() {
		chrome.runtime.sendMessage({ audioSrc: Hg(this.ra, this.qa) });
	};
	var Kg = function(a, b, c) {
			var d = c.toLowerCase();
			d in Ig && Jg[Ig[d.toLowerCase()]] >= b.length
				? (a.P &&
						Ea(a.P, 'no-audio') &&
						(0 == a.P.length && (a.P = null), bf(a, 'no-audio', !1)),
				  (a.ra = b),
				  (a.qa = c))
				: xf(a, 'no-audio');
		},
...
*/
	...
	var Wg = function(a) {
		...
		if (b)
			if (c) {
				...
				l +=
					'</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' +
					cg(b) +
					'</div><br><div class="gtx-language">' +
					cg(e) +
					'</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' +
					cg(c) +
					'</div>';
				if (g) {
					...
					for (c = 0; c < b; c++) {
						d = g[c];
						l +=
							'<tr><td class="gtx-td"><div class="gtx-pos">' +
							cg(d.pos) +
							'</div></td><td class="gtx-td">';
						if (a)
							for (d = d.terms, e = d.length, f = 0; f < e; f++)
								l += (0 != f ? ', ' : '') + cg(d[f]);
						else
							for (d = d.terms, e = d.length, f = 0; f < e; f++)
								(k = d[f]), (l += 3 > f ? (0 != f ? ', ' : '') + cg(k) : '');
						l += '</td></tr>';
					}
					l += '</table>';
				}
	...
	ih.prototype.log = function(a, b, c) {
		if (a.value >= nh(this).value)
			for (
				ea(b) && (b = b()),
					a = new gh(a, String(b), this.h),
					c && (a.a = c),
					c = this;
				c;
	...
	sh.prototype.send = function(a, b, c, d) {
		...
		'withCredentials' in this.a &&
			this.a.withCredentials !== this.sa &&
			(this.a.withCredentials = this.sa);
		try {
			Bh(this),
				0 < this.A &&
					...
					rh(
						...
						zh(
							this,
							'Will abort after ' + this.A + 'ms if incomplete, xhr2 ' + this.M
						)
					),
					this.M
						? ((this.a.timeout = this.A), (this.a.ontimeout = u(this.ra, this)))
						: (this.$ = xg(this.ra, this.A, this))),
				rh(this.b, zh(this, 'Sending request')),
				(this.C = !0),
				this.a.send(a),
				(this.C = !1);
		} catch (f) {
	...
	var Ch = function(a) {
			return (
				F && J(9) && 'number' === typeof a.timeout && void 0 !== a.ontimeout
			);
		},
		Ba = function(a) {
	...
	sh.prototype.ra = function() {
		'undefined' != typeof aa &&
			this.a &&
			((this.u = 'Timed out after ' + this.A + 'ms, aborting'),
			(this.i = 8),
			rh(this.b, zh(this, this.u)),
	...
	sh.prototype.v = function() {
		this.a &&
			(this.g && ((this.g = !1), (this.h = !0), this.a.abort(), (this.h = !1)),
			Eh(this, !0));
		sh.s.v.call(this);
	};
	...
	var Fh = function(a) {
			if (a.g && 'undefined' != typeof aa)
				if (a.O[1] && 4 == Gh(a) && 2 == Hh(a))
					rh(a.b, zh(a, 'Local request error detected and ignored'));
		...
		Ih = function(a) {
			...
			if (!c) {
				if ((b = 0 === b))
					(a = String(a.o).match(Pf)[1] || null),
						!a &&
							n.self &&
							n.self.location &&
							((a = n.self.location.protocol), (a = a.substr(0, a.length - 1))),
						(b = !vh.test(a ? a.toLowerCase() : ''));
				c = b;
			}
			return c;
		},
		...
		for (e in b) {
			...
			if (f.l)
				if (g instanceof Array) {
					var l = [];
					for (var k = 0; k < g.length; k++) l.push(f.l(g[k]).na());
				} else l = f.l(g).na();
			else l = g;
			c[f.c] = l;
		}
	...
	w(Sh, W);
	var Th = {
		source_span_index: { c: 0, f: !1 },
		target_span_index: { c: 1, f: !1 },
		direction: { c: 2, f: !1 }
	};
	...
	w(Uh, W);
	var Vh = { begin: { c: 0, f: !1 }, end: { c: 1, f: !1 } };
	...
	w(Yh, W);
	var Zh = { model_path: { c: 0, f: !1 }, label: { c: 1, f: !1 } };
	...
	w($h, W);
	var ai = { checkpoint_md5: { c: 0, f: !1 }, launch_doc: { c: 1, f: !1 } };
	...
	var li = {
		type: { c: 0, f: !1 },
		display_text: { c: 1, f: !1 },
		contact_text: { c: 2, f: !1 }
	};
	...
	w(qi, W);
	var ri = {
		word_postproc: { c: 0, f: !1 },
		score: { c: 1, f: !1 },
		has_preceding_space: { c: 2, f: !1 },
		attach_to_next_token: { c: 3, f: !1 }
	};
	...
	w(si, W);
	var ti = { begin: { c: 0, f: !1 }, end: { c: 1, f: !1 } };
	...
	var xi = {
		...
		start_pos: { c: 5, f: !1 },
		end_pos: { c: 6, f: !1 },
		not_from_first_segment: { c: 7, f: !1 }
	};
	...
	var Di = {
		word: { c: 0, f: !1 },
		reverse_translation: { c: 1, f: !0 },
		synset_id: { c: 2, f: !0 },
		score: { c: 3, f: !1 },
		previous_word: { c: 4, f: !1 },
		gender: { c: 5, f: !1 }
	};
	...
	var Hi = {
		animacy: { c: 0, f: !1 },
		inflection_aspect: { c: 1, f: !1 },
		grammatical_case: { c: 2, f: !1 },
		degree: { c: 3, f: !1 },
		gender: { c: 4, f: !1 },
		mood: { c: 5, f: !1 },
		nonfinite_form: { c: 6, f: !1 },
		number: { c: 7, f: !1 },
		person: { c: 8, f: !1 },
		polarity: { c: 9, f: !1 },
		referent: { c: 10, f: !1 },
		strength: { c: 11, f: !1 },
		tense: { c: 12, f: !1 },
		imperfect_suffix: { c: 13, f: !1 },
		voice: { c: 14, f: !1 },
		infinitive_number: { c: 15, f: !1 },
		precedes: { c: 16, f: !1 }
	};
	...
	var Ni = {
		srclangs: { c: 0, f: !0 },
		extended_srclangs: { c: 3, f: !0 },
		detected_target: { c: 1, f: !1 },
		srclangs_confidences: { c: 2, f: !0 }
	};
	Mi.prototype.a = function() {
		return Ni;
	};
	...
	w(Qi, W);
	var Ri = {
		spell_html_res: { c: 0, f: !1 },
		spell_res: { c: 1, f: !1 },
		correction_type: { c: 2, f: !0 },
		correction_translation: { c: 3, f: !1 },
		related: { c: 4, f: !1 },
		confident: { c: 5, f: !1 }
	};
	Qi.prototype.a = function() {
	...
	w(Si, W);
	var Ti = { synonym: { c: 0, f: !0 }, definition_id: { c: 1, f: !1 } };
	Si.prototype.a = function() {
		return Ti;
	};
	var Ui = function(a) {
	...
	var hj = function(a, b, c, d) {
		if ('' != a) {
			...
			k.remove('dt');
			0 < e.length &&
				((k.g = null), k.a.set('dt', Ga(e)), (k.b = qa(k.b) + e.length));
			k.set('dj', '1');
			c && k.Ib(c);
			m.set('q', g);
	...
	gj.prototype.a = function(a, b, c, d) {
		if (null != d) {
			for (
				var e = d.src, f = Qg(Ug), g = [], l = [], k = d.sentences, m = 0;
				m < k.length;
				m++
			)
				g.push(k[m].orig), l.push(k[m].trans);
			g = g.join('');
			l = l.join('');
			...
			d = { query: b, Yb: l, Xb: k, Vb: e, Wb: q, Hb: d.dict, popup: a };
			...
			Kg(b, l, f);
			e =
				'https://translate.google.com/?source=gtx_m#' +
				e +
				'/' +
				f +
				'/' +
				encodeURIComponent(window.selection);
			a
				? ((a = Uc(document, 'more')),
				  a.setAttribute('href', e),
				  (c = new V('', void 0, 4)),
				  Me(c, Uc(document, 'new-translation')),
				  ze(Uc(document, 'new-translation'), !0),
				  (c = Uc(document, 'translate-page')),
				  hd(a, Mg('MSG_OPEN_IN_TRANSLATE')),
				  (c.className = 'gtx-a'),
				...
				: ((a = dd(document, 'a')),
				  ...
				  hd(a, Mg('MSG_FOOTER_OPTIONS').toUpperCase()),
				  ...
				  a.setAttribute(
						'style',
						'color: #A2A2A2; float: right; padding-top: 16px;'
				  ),
				  ed(c, a));
	...
	var kj = function(a, b) {
		a.ma &&
			...
			(a.ma = !1),
			la(),
			a.g ? (Pd(a.g, 'end', v(a.lb, b), !1, a), a.g.play()) : a.lb(b));
	};
	h = jj.prototype;
	h.lb = function(a) {
		'toggle_display' == this.oa
			? this.Pb()
			: 'move_offscreen' == this.oa && (this.H.style.top = '-10000px');
	...
	h.Ab = function(a) {
		...
		if ('undefined' != typeof document.activeElement) {
			if (
				((a = b.activeElement),
				!a || gd(this.H, a) || 'BODY' == a.tagName || lj(this, a))
			)
				return;
	...
	var nj = function(a) {
		...
		a =
			...
			U('jfk-bubble') +
			'" role="alertdialog"' +
			(a ? ' aria-describedby="' + U(a) + '"' : '') +
			'><div class="' +
			U('jfk-bubble-content-id') +
			'"' +
			(a ? ' id="' + U(a) + '"' : '') +
			'></div>';
		b &&
			((b = a +=
				'<div class="' +
				U('jfk-bubble-closebtn-id') +
				' ' +
				U('jfk-bubble-closebtn') +
				'" aria-label="'),
			(a = 'Close'.replace(gg, hg)),
			(a = b + a + '" role="button" tabindex=0></div>'));
		a +=
			'<div class="' +
			U('jfk-bubble-arrow-id') +
			' ' +
			U('jfk-bubble-arrow') +
			'"><div class="' +
			U('jfk-bubble-arrowimplbefore') +
			'"></div><div class="' +
			U('jfk-bubble-arrowimplafter') +
			'"></div></div></div>';
		return bg(a);
	};
	...
	oj.prototype.listen = function(a, b, c, d, e) {
		var f = function(g) {
			var l = Qd(b),
				k = g.target;
			k =
				t(k) && 1 == k.nodeType ? g.target.getAttribute('role') || null : null;
			'click' == g.type && Dd(g)
				? l.call(d, g)
				...
				? 32 != g.keyCode ||
				  'keyup' != g.type ||
				  ('button' != k && 'tab' != k) ||
				  (l.call(d, g), g.preventDefault())
				: ((g.type = 'keypress'), l.call(d, g));
		};
		f.Rb = b;
		f.Tb = d;
	...
	var sj = function(a, b) {
		...
		tj = Ha(function() {
			...
			var a = dd(document, 'DIV'),
				b = H ? '-webkit' : G ? '-moz' : F ? '-ms' : ac ? '-o' : null,
						...
						if (g instanceof Ra) g = Sa(g);
							...
							if (!(g instanceof nb)) {
								...
								for (e in g) {
									...
									var k = g[e];
									null != k &&
										((k = Array.isArray(k) ? ya(k, rb).join(' ') : rb(k)),
										(l += e + ':' + k + ';'));
								}
								g = l ? ob(l) : pb;
							}
							g instanceof nb && g.constructor === nb && g.b === mb
								? (e = g.a)
								: (y(
							...
							if (f.toLowerCase() in Ib)
								if (g instanceof Va)
									g instanceof Va && g.constructor === Va && g.b === Ua
										? (e = g.a)
										: (y(
								...
								else if ('string' === typeof g) g = lb(g).R();
								else
									throw Error(
										'Attribute "' +
											f +
			...
			!0 === Oa.div
				? (x(!d.length, 'Void tag <div> does not allow content.'), (m += '>'))
				: ((c = Mb(d)), (m += '>' + Eb(c).toString() + '</div>'), (c = c.ha()));
			...
			return (
				'' !=
				('undefined' !== typeof b ? b : a.style[ie(a, 'transition')] || '')
			);
		});
	...
	h.play = function() {
		...
		this.b = 1;
		if (tj())
			return je(this.a, this.o), (this.h = xg(this.Sb, void 0, this)), !0;
		this.hb(!1);
		return !1;
	};
	h.Sb = function() {
	...
	var vj = function(a, b, c, d) {
		return new uj(
			...
			{ opacity: c },
			{ opacity: d },
			{ Db: 'opacity', duration: 0.218, timing: b, delay: 0 }
		);
	};
	var wj = function(a) {
		He.call(this, a);
	...
	h.Ta = function() {
		this.a = Bg(nj, { Ub: !0, uid: 'bubble-' + ia(this) }, this.h);
		xj(this, this.U);
		ze(this.m(), !1);
		var a = this.g,
			b = this.m();
	...
	h.zb = function(a) {
		...
		if (a) {
			if (!b.ma && b.dispatchEvent('beforeshow')) {
				...
				'toggle_display' == b.oa
					? ((b.H.style.visibility = 'visible'), ze(b.H, !0))
					: 'move_offscreen' == b.oa && b.b();
				b.ma = !0;
				b.cb = la();
	...
	h.Ob = function(a) {
		if ('show' == a.type || 'hide' == a.type) {
			...
			c = F ? Zc(c.a) : c.a;
			'show' == a.type
				? b.listen(c, 'scroll', this.xb)
				: b.N(c, 'scroll', this.xb);
		}
	...
	var yj = function(a) {
			...
			parseInt(a.style.top, 10) -
				Yc(document).scrollTop +
				parseInt(a.style.height, 10) / 2 <
				window.innerHeight / 2 && (b = 1);
			var c = 2;
	...
	yj.prototype.T = function(a, b) {
		...
		b = this.u;
		x(
			'string' === typeof b || b.nodeType || b instanceof Yf || b instanceof Db,
	...
	var Dj = function(a, b, c) {
		...
		Ij = function(a, b, c) {
			if (a) {
				...
				chrome.i18n.detectLanguage(d, function(e) {
					e.isReliable
						? c(e.languages[0].language)
						: 0 < b
						? Ij(a.parentNode, b - 1, c)
						: c('');
				});
			} else c('');
		},
		Gj = function(a, b, c, d) {
			...
			if (0 != b.top || 0 != b.left)
				if ('1' == Sg.a) {
					...
					f.style.left = a.clientX + Yc(document).scrollLeft - 13 + 'px';
					a = a.clientY;
					a - b.top > b.height / 2 ? (a = b.bottom + 1) : (a = b.top - 1 - 27);
					f.style.top = a + Yc(document).scrollTop + 'px';
					document.body.appendChild(f);
					P(f, 'click', v(Dj, b, c, d));
				} else hj(c, v(Cj, b), 'bubble', d);
		},
		Fj = function(a, b) {
		...
		Cj = function(a, b) {
			if ('1' == Sg.a || b.src != Qg(Sg)) {
				...
				c.style.left = String(a.left + Yc(document).scrollLeft + 'px');
				c.style.top = String(a.top + Yc(document).scrollTop + 'px');
				...
				a.C = a.u.attachShadow({ mode: 'closed' });
				Jj(chrome.runtime.getURL('popup_css_compiled.css'), u(a.T, a, b));
				window.a.zb(!0);
			}
		},
		Jj = function(a, b) {
	...
	P(window, 'mouseup', function(a) {
		if (0 == a.button && !Uc(document, 'gtx-trans')) {
			...
			Pg || '1' != Sg.a || !Sg.h || zj
				? window.setTimeout(v(Hj, a), 0)
				: ((Aj = a), chrome.runtime.sendMessage({ detectLanguage: 1 }));
		}
	});
	P(
		window,
		...
		function(a) {
			...
			a.target instanceof HTMLElement &&
				-1 != a.target.className.indexOf('jfk-bubble-closebtn') &&
				a.preventDefault();
		},
		!0
	);
	var Kj = function() {
		...
		Mj = n;
	Lj[0] in Mj ||
		'undefined' == typeof Mj.execScript ||
		Mj.execScript('var ' + Lj[0]);
	for (var Nj; Lj.length && (Nj = Lj.shift()); )
		Lj.length || void 0 === Kj
			? Mj[Nj] && Mj[Nj] !== Object.prototype[Nj]
				? (Mj = Mj[Nj])
				: (Mj = Mj[Nj] = {})
			: (Mj[Nj] = Kj);
})();
